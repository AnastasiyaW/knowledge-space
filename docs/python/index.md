...
- [[oop-advanced]] - ABC, descriptors, metaclasses, dataclasses, __slots__, __init_subclass__
...
- [[standard-library]] - collections, datetime, timedelta, random, functools
- [[iterators-and-generators]] - iterator protocol, yield, yield from, itertools, pipelines
