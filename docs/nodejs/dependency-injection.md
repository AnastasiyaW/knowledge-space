...
Structural patterns for isolation: [Design Patterns (GoF) in JavaScript](design-patterns-gof.md) (convert interfaces), Proxy (control access), Facade (simplify subsystem), Composite (uniform tree traversal).
