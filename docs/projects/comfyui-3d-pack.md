...
category: projects
tags: [comfy-cloud-pricing, comfyui, comfyui-3d-pack, comfyui-development, comfyui_core_updates, comfyui_desktop, ecosystem_grants, product_updates, project]
aliases: ["Comfy Cloud", "ComfyUI"]
---

# ComfyUI — ComfyUI Development

**Development line:** `project:comfyui-3d-pack` · thread `comfyui-development`  
...
- **Subject:** `project:comfyui-3d-pack`, thread `comfyui-development`, 19 dated events 2023-11-24 → 2026-03-26.
