---
title: Data2Story — Agentic Data Storytelling
category: projects
date: 2026-06-16
tags: [agentic-data-storytelling, agentic_data_storytelling, data2story, project]
aliases: ["Data2Story"]
---

# Data2Story — Agentic Data Storytelling

**Development line:** `project:data2story` · thread `agentic-data-storytelling`  
**Last event:** 2026-06-16 · 1 dated since 2026-06-16 · **Researched:** 2026-09-05 · confidence: high
...
2. Provide a CSV, JSON file, data directory, paper, or—in Pro—an idea or URL; run the orchestrator against that input.
  — <https://raw.githubusercontent.com/QinghongLin/data2story-skill/main/skills/data2story-pro/README.md>
3. Open `index.html` for the article and inspect claims through `viewer.html` in the canonical skill or the in-page inspector in Pro.
  — <https://raw.githubusercontent.com/QinghongLin/data2story-skill/main/skills/data2story/SKILL.md>

## Best practices

- Run the fixed stages in order and do not advance until the prior artifact is complete.
  — <https://raw.githubusercontent.com/QinghongLin/data2story-skill/main/skills/data2story/SKILL.md>
...
| source | title | read |
|---|---|---|
| https://data2story.github.io/ | Data Journalist Agent (Data2Story) | 2026-09-05 |
| https://github.com/QinghongLin/data2story-skill | QinghongLin/data2story-skill repository | 2026-09-05 |
| https://arxiv.org/abs/2606.11176 | Data Journalist Agent: Transforming Data into Verifiable Multimodal Stories | 2026-09-05 |
| https://raw.githubusercontent.com/QinghongLin/data2story-skill/main/skills/data2story/SKILL.md | Data2Story canonical skill orchestrator | 2026-09-05 |
| https://raw.githubusercontent.com/QinghongLin/data2story-skill/main/skills/data2story-pro/README.md | Data2Story Pro README | 2026-09-05 |

## Agent brief {#agent-brief}

- **Subject:** `project:data2story`, thread `agentic-data-storytelling`, 1 dated events 2026-06-16 → 2026-06-16.
- **Practical note:** As of 2026-06-16, practitioners can use the supplied project website and GitHub repository as the starting references when evaluating Data2Story for agentic data-storytelling work.
