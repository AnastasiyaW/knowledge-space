...
category: projects
date: 2023-06-22
tags: [project, sdxl, sdxl-development]
aliases: ["SDXL", "SDXL 0.9", "SDXL 1.0"]
---

# SDXL

**Development line:** `project:sdxl` · thread `sdxl-development`  
**Last event:** 2023-06-22 · 2 dated since 2023-05-24 · **Researched:** 2026-09-04 · confidence: medium

## What it is

SDXL: a Stable Diffusion model for practitioners who need prompt-driven image generation.

- Generates text-to-image, image-to-image, and inpainting outputs.
- Runs the official 1.0 base checkpoint alone or with an optional refiner.
- Default target: 1024×1024; default checkpoints are not recommended below 512 pixels.
...
- **2023-06-22 — Stability AI published an SDXL 0.9 update.** It was available through Clipdrop, research weights were available, and 1.0 was planned for mid-July.
...
- **Subject:** `project:sdxl`, thread `sdxl-development`, 2 dated events 2023-05-24 → 2023-06-22.
