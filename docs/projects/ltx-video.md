...
- Pro features: audio-to-video, Retake, Extend, and Reframe.
- Weight paths: dev, distilled, fp8, and latent-upscaler checkpoints.

22B parameters; the current Hugging Face repository is 156 GB and the dev checkpoint alone is 46.1 GB. We keep it for existing integrations and 2.3-specific adapters; begin new multi-shot, footage-editing, or deep fine-tuning work on LTX-2.5.
...
From 2026-03-05, practitioners can use LTX-2.3 through its documented text-to-video route or the linked ComfyUI workflow; from 2026-07-30, they should evaluate the dedicated 22B IC relighting LoRA when relighting is required.
...
- **Practical note:** From 2026-03-05, practitioners can use LTX-2.3 through its documented text-to-video route or the linked ComfyUI workflow; from 2026-07-30, they should evaluate the dedicated 22B IC relighting LoRA when relighting is required.
