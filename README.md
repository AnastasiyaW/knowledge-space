...
**1089+ articles | 28 domains | 3134+ cross-references**
...
|--------|:--------:|----------|
| `projects/` | 195 | One page per tool, model or product the news conveyor follows: dated development line, current use, obsolete guidance, sources |
...
| `organizations/` | 42 | One page per company or lab: leadership and structure changes, product lines, what each change made obsolete |
