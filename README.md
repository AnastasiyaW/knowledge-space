...
**887+ articles | 28 domains | 3128+ cross-references**
...
| `organizations/` | 24 | One page per company or lab: leadership and structure changes, product lines, what each change made obsolete |
...
| `projects/` | 11 | One page per tool, model or product the news conveyor follows: dated development line, current use, obsolete guidance, sources |
